  ...
  return (
    <>
      <div className="flex main border-b-2 border-black overflow-x-hidden">
        <h1
          ref={textref}
          className="translate-x-[100vw] lg:h-[100vh] sm:h-[30vh] md:h-[80vh] md:text-[50vh] lg:text-[60vh] text-black font-medium text-[25vh]"
        >
          PROJECTS.
        </h1>
      </div>
      ...
      <div className="flex h-full w-full items-center justify-center">
        <div className="grid h-screen w-full grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-2 rounded-lg shadow-lg">
          <div
            onMouseEnter={() => setactive("one")}
            onMouseLeave={() => setactive(null)}
            className="col-span-1 sm:col-span-2 md:col-span-2 row-span-1 sm:row-span-2 overflow-hidden rounded-lg shadow-md flex items-center justify-center font-sans"
          >
            {active === "one" ? (
